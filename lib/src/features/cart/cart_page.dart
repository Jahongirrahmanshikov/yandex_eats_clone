...
import 'package:yandex_eats/src/features/cart/empty_cart.dart';
...
class _CartPageState extends State<CartPage> {
  ...
  Widget build(BuildContext context) {
    if (context.read<MainController>().user.korzinka == null ||
        context.read<MainController>().user.korzinka!.isEmpty) {
